...
public interface AlumnoDao extends Dao<PerfilAlumno>{
	...
	//DMS 10/10/23 sobrecargo metodo con anioEgreso para usar en el filtrado
	public List<ExportarAlumnosDTO> obtenerAlumnosExportar(int firstResult, int maxResults,
			SortOrderEnum sortDirection, String sortCriterion, EstadoAlumno estadoAlumno, ZonaCimientos zona, 
	...
	public Integer obtenerCantidadAlumnosExportar(EstadoAlumno estadoAlumno, 
			ZonaCimientos zona, Convocatoria convocatoria, PerfilPadrino padrino, PerfilEA ea,
			String nombreAlumno, List<AnioEscolar> anios, Boolean adicional, boolean becadosActivos,
			String eae, Escuela escuela,Integer[] aniosEgreso,Integer dni, String localidad, String provincia,Long idRa,Long idRr);
