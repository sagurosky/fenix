...
public class AlumnoSrv {
	...
	public List<ExportarAlumnosDTO> obtenerAlumnosExportar(int firstResult, int maxResults,
            ...
            Convocatoria convocatoria, PerfilPadrino padrino, PerfilEA ea, String nombreAlumno, List<AnioEscolar> anios,
            Boolean adicional, boolean becadosActivos, String eae, Escuela escuela,Integer[] aniosEgreso,Integer dni,
            String localidad, String provincia, Long idRa, Long idRr){
		return dao.obtenerAlumnosExportar(firstResult,maxResults,sortDirection,sortCriterion,estadoAlumno,zona,
				convocatoria,padrino,ea,nombreAlumno,anios,adicional, becadosActivos,eae, escuela,aniosEgreso,
				dni,localidad,provincia,idRa,idRr);
	}
	...
	public Integer obtenerCantidadAlumnosExportar(EstadoAlumno estadoAlumno, 
			ZonaCimientos zona, Convocatoria convocatoria, PerfilPadrino padrino,
			PerfilEA ea, String nombreAlumno, List<AnioEscolar> anios, Boolean adicional,
			boolean becadosActivos, String eae, Escuela escuela,Integer[] aniosEgreso,Integer dni,
			String localidad, String provincia, Long idRa, Long idRr ){
		return dao.obtenerCantidadAlumnosExportar(estadoAlumno,zona,convocatoria,padrino,ea,
				nombreAlumno,anios,adicional,becadosActivos,eae, escuela,aniosEgreso,dni,
				localidad, provincia,idRa,idRr);
	}
	...
	public List<BoletinDTO> cargaBoletinDTO(List<ExportarAlumnosDTO> alumnosDTO, CicloPrograma ciclo){		
		...
		for (ExportarAlumnosDTO alumnoDTO : alumnosDTO){			
			...
			//DMS diagnostico
			System.out.println("id alumno: "+alumnoDTO.getAlumno().getId());
