...
public class BoletinExcelView extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map<String,Object> model, HSSFWorkbook workbook,
		...
		int totalRows = alumnoSrv.obtenerCantidadAlumnosExportar(estadoAlumno,zona,convocatoria,padrino,ea,nombreAlumno,anios,adicional,becadosActivos,eae, escuela,null,null,null,null,null,null);
