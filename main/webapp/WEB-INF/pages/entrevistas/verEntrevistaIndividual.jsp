...
<div class="row">
	...
	<c:choose>
		...
		<div class="form-group form-inline">
			<label class="text-danger">Información adicional sobre la escuela &nbsp;&nbsp;</label>
			<br><br>
			<label>Atención. Esta información se incluye en el Informe de Seguimiento<img src="../static/images/atencion.gif" width=10></label>				
 ...
 <div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p style="font-size:25px; color:red;">Si aún no creaste el boletín 2023, recordá hacerlo, porque no podrás finalizar la Entrevista del mes de Septiembre 2024</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
        </div>
