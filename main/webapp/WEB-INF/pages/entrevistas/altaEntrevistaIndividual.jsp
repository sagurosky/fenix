		...
		<div class="position-fixed">
			...
			<div class="form-group">				
					<c:if test="${boletin=='SinBoletin'}">
						<b><font color="red"  size="2">No tenés cargado el Boletín</font></b>
					</c:if>
					<c:if test="${tipoPerfil == 'rr' && boletin=='ConBoletin'}">
						<input type="button" id="btnFinalizar" name="btnFinalizar" class="btn btn-secondary "  value="Finalizar" class="ui-state-default ui-corner-all" onclick="guardarAprobar('f','${tipoPerfil}');" />
					</c:if>
	...
	<c:choose>
 		<c:when test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
			...
			<div class="form-group form-inline">
				...
				<br><br>
				<form:textarea path="tarang" rows="4" cols="140" onblur="chequearLongitud(this);" 
				placeholder="Mencionar el trabajo de acompañamiento realizado con el grupo de estudiantes de una misma etapa escolar. Considerar habilidades y contenidos trabajados, estrategias y actividades, herramientas y recursos utilizados, modalidad de los encuentros, dinámicas de trabajo (individual/grupal)."
				onkeypress="chequearLongitud(this);" style='width:auto' class="form-control"/>
			</div>
			<div class="form-group form-inline">
		...
		<div class="form-group form-inline">
			...
			<form:textarea path="iatarni" rows="4" cols="140" 
			placeholder="Mencionar trabajo de acompañamiento realizado en forma individual, tener en cuenta la valoración realizada previamente sobre la trayectoria escolar y en el programa del estudiante. Considerar materias aprobadas, desaprobadas y pendientes, motivos de inasistencias (si hubiere). Logros y Dificultades que se observan en el EP. Acuerdos/acciones implementados ante dificultades. Situaciones de riesgo (si hubiere)."			
			onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" style='width:auto' class="form-control"/>
		</div>
		<div class="form-group form-inline">
		...
		<c:if test="${(egreso==2023 || egreso==2024)}">
			<div class="card bg-info text-white">
		...
		<div class="form-group form-inline">
			<label>Información adicional sobre la escuela &nbsp;&nbsp;</label>
			<br><br>
			<label>Atención. Esta información se incluye en el Informe de Seguimiento<img src="../static/images/atencion.gif" width=10></label>				
			<form:textarea path="ige" rows="4" cols="140" 
			placeholder=" Incluir información relevante del primer semestre, considerar estrategias específicas implementadas, fechas de exámen y entrega de boletines/libretas, información sobre condiciones edilicias, paros y clases,etc."
			onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" style='width:auto' class="form-control"/>
		</div>	
		<div class="form-group form-inline">
...
$(document).ready(() => {
	...
	//alert(mes);
	if(mes=="4" && (dia=="27" || dia=="28")){	
	
		$("#btnFinalizar").prop('disabled', true); 
		alert("Ya finalizó el período para registrar entrevistas del mes, vas a poder finalizar esta entrevista el 1ro del mes siguiente");
	}
	if(mes=="5" && (dia=="30" || dia=="31")){	
	
		$("#btnFinalizar").prop('disabled', true); 
		alert("Ya finalizó el período para registrar entrevistas del mes, vas a poder finalizar esta entrevista el 1ro del mes siguiente");
	}
	if(mes=="6" && (dia=="29" || dia=="30")){	
	
		$("#btnFinalizar").prop('disabled', true); 
		alert("Ya finalizó el período para registrar entrevistas del mes, vas a poder finalizar esta entrevista el 1ro del mes siguiente");
	}
	//if(mes=="7" && (dia=="30" || dia=="31")){	
	
	//	$("#btnFinalizar").prop('disabled', true); 
	//	alert("Ya finalizó el período para registrar entrevistas del mes, vas a poder finalizar esta entrevista el 1ro del mes siguiente");
	//}
	if(mes=="8" && (dia=="30" || dia=="31")){	
	
		$("#btnFinalizar").prop('disabled', true); 
		alert("Ya finalizó el período para registrar entrevistas del mes, vas a poder finalizar esta entrevista el 1ro del mes siguiente");
	}
	if(mes=="9" && (dia=="29" || dia=="30")){	
	...
	if(mes=="11" && (dia=="29" || dia=="30")){	
	
		$("#btnFinalizar").prop('disabled', true); 
		alert("Ya finalizó el período para registrar entrevistas del mes, vas a poder finalizar esta entrevista el 1ro del mes siguiente");
	}
	if(mes=="12" && (dia=="21" || dia=="22")){	
...
function guardarAprobar(valor, valorPerfil){		
	...
	if(document.forms['altaEntrevistaIndividual'].hsTrabajarAño.value=="Otra" && 
			document.forms['altaEntrevistaIndividual'].observacionesGenerales.value=="" ){					
		texto=texto+"<li>Otra Principal HSE trabajada en esta primer parte del año</li>";
	}
	...
	if(document.forms['altaEntrevistaIndividual'].periodo.value=="Julio"){						
		...
		if(document.forms['altaEntrevistaIndividual'].anioEgreso.value=="2023" || document.forms['altaEntrevistaIndividual'].anioEgreso.value=="2024"){
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p style="font-size:25px; color:red;">Si aún no creaste el boletín 2023, recordá hacerlo, sino no podrás generar la próxima Entrevista del mes de Septiembre 2023</p>
        </div>
 ...
 <div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p style="font-size:25px; color:red;">Si aún no creaste el boletín 2023, recordá hacerlo, porque no podrás finalizar la Entrevista del mes de Septiembre 2023</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
        </div>
