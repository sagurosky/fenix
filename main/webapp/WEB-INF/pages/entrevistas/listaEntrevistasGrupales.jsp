			...
			<tbody align="center">
				<c:forEach items="${entrevistas}" var="e">
					<tr>
						...
						<td align="center" valign="middle" style="font-size: 14px" class="col2">&nbsp;${e.lugarEntrevista.localidad.nombre}&nbsp;</td>
						<td align="center" valign="middle" style="font-size: 14px" class="col2">&nbsp;${e.lugarEntrevista.localidad.provincia.descripcion}&nbsp;</td>
						<td align="center" valign="middle" style="font-size: 14px" class="col2">&nbsp;${e.lugarEntrevista.localidad.zona.nombre}&nbsp;</td>
						<td align="center" valign="middle" style="font-size: 14px" class="col2">&nbsp;${e.ea.datosPersonales.apellido},${e.ea.datosPersonales.nombre}&nbsp;</td>
						<td align="center" valign="middle" style="font-size: 14px" class="col2">&nbsp;${e.rr.datosPersonales.apellido},${e.rr.datosPersonales.nombre}&nbsp;</td>
