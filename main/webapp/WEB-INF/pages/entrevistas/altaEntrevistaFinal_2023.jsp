	...
	function guardarAprobar(valor, valorPerfil){
		...
		if (document.forms['altaEntrevistaIndividual'].evaluacionCobroBeca.value == 3 ) { 
			...
			if (valor == 'f' || valor == 's'){
				...
				if(document.forms['altaEntrevistaIndividual'].anioEgreso.value=="2024"){
					if(document.forms['altaEntrevistaIndividual'].dirMail.value==""){			
						jAlert('warning', 'Falta completar Dirección de mail ', 'Atención!');  
						return false;	
					}
...
<div class="form-group">
	...
	<form:textarea path="paa" readonly="true" class="form-control"  id="propositoAnual" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>										
</div>
<br>
<div class="jumbotron">
