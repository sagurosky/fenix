...
<table id="table-informe">
	...
	<td nowrap="nowrap"><label>Categoría de Propósito anual</label>
		...
		<tr>
		<td nowrap="nowrap"><label>Principales Contenidos<br>a trabajar en el año</label></td>
		<td>
...
<table id="table-informe">
	...
	<tr>
		<td nowrap="nowrap"><label>Objetivo del encuentro<br>y actividad implementada<br> + Observaciones del<br>estudiante</label></td>	
		<td>
	...
	<tr>
		<td nowrap="nowrap"><label>Observaciones sobre<br>situaciones de riesgo</label></td>
		<td>
...
<table id="table-informe">
	<tr>
		...
		<td nowrap="nowrap"><label>Información adicional<br>del estudiante<br>Esta información se envía<br>al padrino <img src="../static/images/atencion.gif" width=10><br></label></td>
		<td>
