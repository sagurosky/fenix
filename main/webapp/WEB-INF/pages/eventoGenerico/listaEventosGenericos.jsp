		...
		<tbody align="center">
			<c:forEach items="${eventos}" var="evento">
				<tr>
					...
					<td align="left" valign="middle" style="font-size: 14px" class="col3">&nbsp;${evento.lugarEncuentro.localidad.nombre}&nbsp;</td>
					<td align="left" valign="middle" style="font-size: 14px" class="col3">&nbsp;${evento.lugarEncuentro.localidad.provincia.descripcion}&nbsp;</td>
					<td align="left" valign="middle" style="font-size: 14px" class="col0">&nbsp;${evento.lugarEncuentro.localidad.zona.nombre}&nbsp;</td>
					<td align="left" valign="middle" style="font-size: 14px" class="col0">&nbsp;${evento.ea.datosPersonales.apellido},${evento.ea.datosPersonales.nombre}&nbsp;</td>
					<td align="left" valign="middle" style="font-size: 14px" class="col0">&nbsp;${evento.ea.rr.datosPersonales.apellido},${evento.ea.rr.datosPersonales.nombre}&nbsp;</td>
