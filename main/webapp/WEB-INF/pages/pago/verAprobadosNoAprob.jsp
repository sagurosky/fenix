...
//		alert(document.forms['form'].banco.value);
...
<table id="table-informe" align="center" style="margin-left: 100px; margin-right: 60px; border-style:hidden;" width="600px">
		...
		<tr align="center">
			<!--  RA -->
			<td align="left" style="font-size: 13px; font-weight: bold">Titular Cta:</td>
			<td align="left">
		...
		<tr>
			...
			<td align="left" style="font-size: 13px; font-weight: bold">
				Paga por Galicia<input type="checkbox" name="pagaXGalicia" id="pagaXGalicia" onclick="habilitarFechas()">
			</td>
		</tr>
		<tr>			
...
<display:table name="sessionScope.pagosList"   form="form" decorator="org.cimientos.intranet.utils.paginacion.PagosCheckboxDecorator" sort="external"
    ...
    <display:column property="nombreRa" sortProperty="responsable.apellido" sortable="true" style="width: 15%" headerClass="sortable" title="Titular Cta"  />  
