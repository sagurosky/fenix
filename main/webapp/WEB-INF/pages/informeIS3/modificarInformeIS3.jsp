...
<body>
	<div id="main-content">
		<form id="modificarInformeIS3" class="cmxform" action="" method="post">
			estado entrevista:<input type="text" id="estadoEntrevista" name="estadoEntrevista" value="${estadoEntrevista}"></input>
			eval renovacion beca:<input type="text" id="evalRenovacionBeca" name="evalRenovacionBeca" value="${evalRenovacionBeca}"></input>
			<h1 id="titulo-informe">:: Informe de Seguimiento Nº 3 ::</h1>
			<c:set var="urlRegreso" value="${urlRegreso}"></c:set>
			<table border="0" align="left" cellpadding="0" cellspacing="0"
				id="table-informe">
				<tr>
					<td><label>Construcción - Mod 2023</label></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
			...
			<div class="form-group form-inline">
				<label>Compromiso activo para rendir materias pendientes de años anteriores: </label>				
			...
			<input type="hidden" name="edad" id="edad" value="${edad}"></input> 
			...
			<input type="hidden" name="idInformeIS3" id="idInformeIS3" value="${idInformeis3}"></input> 
