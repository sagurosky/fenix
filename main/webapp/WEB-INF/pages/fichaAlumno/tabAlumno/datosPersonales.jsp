...
<fieldset>
	<table width="100%" align="left" cellspacing="3">
		...
		<tr>
			...
			<td><input class="form-control"type="text" onchange="this.value=this.value.toUpperCase();" id="alumnoNombre"
		...
		<tr>
			...
			<td><input type="text" onchange="this.value=this.value.toUpperCase();" id="alumnoApellido"
				name="datosPersonales.apellido" class="required form-control"
				value="${perfilAlumno.datosPersonales.apellido}"></td>
			<td colspan="2">
		</tr>
		<tr>
			<td>Tipo de DNI</td>
			<td><select name="tipoDNI" id="dni" class="required form-control" style="width:200px" >
		...
		<tr>
			...
			<sec:authorize access="not hasRole('SuperUsuario')">
				<td>
					<input type="text" id="dniAlumno"
						...
						name="datosPersonales.dni" class="digits required form-control"
			...
			<sec:authorize access="hasRole('SuperUsuario')">
				<td>
					<input type="text" id="dniAlumno"
						onkeypress="validarDNI('dniAlumno')" name="datosPersonales.dni" class="digits required form-control"
						maxlength="8" value="${perfilAlumno.datosPersonales.dni}">
				</td>
			</sec:authorize>
			<td colspan="2">
		...
		<tr>
			...
			<td><!-- input type="text"  onchange="this.value=this.value.toUpperCase();" id="alumnoNacionalidad"
				...
				<select name="alumnoNacionalidad" id="alumnoNacionalidad" class="required form-control" style="width:200px">
					<c:choose>
		...
		<tr>
			...
			<td><input name="fechaNac" id="fechaDeNacimiento" class="form-control"style="width:200px"
...
<!-- 			<td><font color="green">Calle *Direccion</font></td> -->
			<td><input type="hidden" onchange="this.value=this.value.toUpperCase();"  id="alumnoDireccion"
...
<!-- 			<td><font color="green">Número *</font></td> -->
			<td><input type="hidden" onchange="this.value=this.value.toUpperCase();"  id="alumnoNumero"
		...
		<tr>
<!-- 			<td>Piso/Manzana</td> -->
			<td><input type="hidden" onchange="this.value=this.value.toUpperCase();"  id="alumnoPiso"
...
<!-- 			<td><font color="green">Código Postal *</font></td> -->
			<td><input type="hidden" onchange="this.value=this.value.toUpperCase();"  id="alumnoCodigoPostal"
...
<!-- 			<td><font color="green">Entre Calles *</font></td> -->
			<td><input type="hidden" onchange="this.value=this.value.toUpperCase();"  id="alumnoEntreCalles"
...
<!-- 			<td><input type="hidden" onchange="this.value=this.value.toUpperCase();"  id="barrio" -->
...
<!-- 			<td colspan="2"> -->
		...
		<tr>
<!-- 			<td>Localidad</td> -->
<!-- 			<td><select name="idLocalidad" hidden> -->
...
<!-- 			</select></td> -->
		...
		<tr>
<!-- 			<td>Provincia</td> -->
<!-- 			<td><select name="idProvincia"hidden> -->
...
<!-- 			</select></td> -->
		...
		<tr>
			...
			<td><input type="text" onchange="this.value=this.value.toUpperCase();"
				...
				class="form-control" value="${perfilAlumno.datosPersonales.telefono}" onkeypress="return justNumbers(event);" class="required" />
			</td>
			<td colspan="2">
		</tr>
		<tr>
<!-- 			<td>Contacto 1</td> -->
			<td><input type="hidden" name="contactoTelefono1" onchange="this.value=this.value.toUpperCase();" id="alumnoContactoTelefono1" value="${perfilAlumno.contactoTelefono1}" /></td>
			<td colspan="2">
		</td>	
		<tr>
<!-- 			<td width="100">Teléfono 1 (cargá el código de área)</td> -->
			<td width="200"><input type="hidden" name="telefono1"  maxlength="19"
		...
		<tr>
<!-- 			<td>Contacto 2</td> -->
			<td><input type="hidden" name="contactoTelefono2" onchange="this.value=this.value.toUpperCase();"
					id="alumnoContactoTelefono2" value="${perfilAlumno.contactoTelefono2}" />
<!-- 			Teléfono 2 (cargá el código de área) -->
			<input type="hidden" name="telefono2"  maxlength="19"
					id="alumnoContactoTelefono2" value="${perfilAlumno.telefono2}" onkeypress="return justNumbers(event);" /></td>
		</tr>
		<tr>
			<td>Mail</td>
			<td><input type="text" name="datosPersonales.mail" class="form-control" onchange="this.value=this.value.toUpperCase();"
