...
$(document).ready(function(){
// alert("es EA");
$(".ocultarEA").attr("readonly","readonly");
$(".ocultarEA").attr("disabled","disabled");
$(".ocultarEA").addClass("readOnly");
$(".ocultarEA").addClass("disabled");

});

// $(".ocultarEA").click(function(){alert("no modificable por EA")}); DMS no funciona ver despues
...
<div id="accordion" style="width: auto;">
		...
		<h3 class="ui-accordion-header  ui-state-default ui-corner-all"align="left"><a href="#" onclick="mostrar(5)">Información extra</a></h3>
				<div id="observacionesGenerales"style="width: auto; height: auto; overflow: scroll;">
					<jsp:include page="tabAlumno/informacionExtra.jsp"></jsp:include>
				</div>	
